...
const styles = StyleSheet.create({
  ...
  tripName: { ...type.heading, fontWeight: "bold", color: colors.onBrand },
  ...
  modalTitle: { ...type.heading, fontWeight: "bold", color: colors.text900, marginBottom: space.xs },
  ...
  editLabel: { ...type.label, fontWeight: "600", color: colors.onBrandMuted, marginTop: space.md, marginBottom: space.sm },
  editInput: {
  ...
  editCurrencyChipText: { ...type.label, fontWeight: "600", color: colors.onBrand },
  ...
  avatarLgText: { ...type.label, fontWeight: "bold", color: colors.onBrand },
  memberInfo: { flex: 1 },
  memberRowName: { ...type.body, fontWeight: "600", color: colors.text900 },
  ...
  weightVal: { ...type.body, fontWeight: "bold", color: colors.text900, minWidth: 20, textAlign: "center", fontVariant: ["tabular-nums"] },
  ...
  blockedTitle: { ...type.label, fontWeight: "700", color: colors.text600, marginBottom: space.md },
  ...
  btnSaveText: { ...type.body, color: colors.brand600, fontWeight: "bold" },
  ...
  tripOptionName: { ...type.body, fontWeight: "600", color: colors.text900 },
  ...
  newTripBtnText: { ...type.body, color: colors.onBrand, fontWeight: "bold" },

...
const styles = StyleSheet.create({
  ...
  summaryVal: { ...type.body, fontWeight: "bold", color: colors.onBrand, fontVariant: ["tabular-nums"] },
  ...
  settledBannerText: { ...type.body, fontWeight: "bold", color: colors.brand600 },
  ...
  settleTitle: { ...type.body, fontWeight: "bold", color: colors.text900 },
  ...
  emptyTitle: { ...type.body, fontWeight: "bold", color: colors.text900, marginBottom: space.sm },
  ...
  expInfo: { flex: 1 },
  expDesc: { ...type.label, fontWeight: "600", color: colors.text900 },
  ...
  expAmount: { ...type.body, fontWeight: "bold", color: colors.brand600, fontVariant: ["tabular-nums"] },
  ...
  modalTitle: { ...type.heading, fontWeight: "bold", color: colors.text900, marginBottom: space.sm },
  label: { ...type.label, fontWeight: "600", color: colors.text600, marginTop: space.sm },
  ...
  currencyBtnText: { ...type.body, fontWeight: "600", color: colors.brand600 },
  ...
  btnSaveText: { ...type.body, color: colors.onBrand, fontWeight: "bold" },
  ...
  settleFrom: { ...type.label, fontWeight: "700", flex: 1 },
  settleArrow: { color: colors.text600 },
  settleTo: { ...type.label, fontWeight: "700" },
  settleLeftLabel: { fontSize: 12, lineHeight: 16, color: "#FF6B6B", fontStyle: "italic" },
  settleAmtCol: { alignItems: "flex-end" },
  settleAmt: { ...type.label, fontWeight: "bold", color: colors.text900, fontVariant: ["tabular-nums"] },
  ...
  settleBtnText: { ...type.label, color: colors.onBrand, fontWeight: "bold" },
  settleBtnAdmin: {
  ...
  settleBtnAdminText: { ...type.label, color: colors.brand600, fontWeight: "bold" },
  ...
  currencyCommonChipText: { ...type.label, fontWeight: "600", color: colors.text600 },
  ...
  currencyRowCode: { ...type.label, fontWeight: "700", color: colors.text900, width: 48 },

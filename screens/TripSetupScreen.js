...
const styles = StyleSheet.create({
  ...
  label: { ...type.label, color: colors.onBrandMuted, fontWeight: "600", marginTop: space.sm, marginBottom: space.xs, fontFamily: "GolosText_600SemiBold" },
  ...
  codeInput: { fontSize: 24, fontWeight: "bold", letterSpacing: 8, textAlign: "center", fontFamily: "GolosText_700Bold" },
  ...
  currencyChipText: { ...type.label, fontWeight: "600", color: colors.onBrand, fontFamily: "GolosText_600SemiBold" },
  ...
  btnPrimaryText: { ...type.body, color: colors.brand600, fontWeight: "bold", fontFamily: "GolosText_700Bold" },
  btnSecondary: {
  ...
  btnSecondaryText: { ...type.body, color: colors.onBrand, fontWeight: "500", fontFamily: "GolosText_500Medium" },

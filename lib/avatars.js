...
import { AVATAR, shrinkPhoto } from "./image";
...
export async function uploadAvatar(userId, assetUri, previousPath) {
  const uri = await shrinkPhoto(assetUri, null, AVATAR, true);
